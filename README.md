<!-- Ramalingam S – GitHub Profile README -->
...
```
🎓  B.E. Computer Science & Engineering @ Rajalakshmi Engineering College (2023–2027)
...
![XGBoost](https://img.shields.io/badge/XGBoost-E07B39?style=for-the-badge&logo=xgboost&logoColor=white)
...
`Flutter` `Firebase Auth` `Firestore` `Cloudinary` `REST APIs`
...
`Python` `Django` `Flask` `XGBoost` `RandomForestClassifier` `Scikit-learn` `Pandas`
...
| Big Data Analysis with Hadoop | Wipro Technologies |
| Python for Data Science | NPTEL |
| The Joy of Computing using Python (Elite Silver) | NPTEL |
| Data Science, ML & Deep Learning Bootcamp | Udemy |
...
<div align="center">
<sub>📍 Chennai, Tamil Nadu · Open to internships & collaborations</sub>
</div>
